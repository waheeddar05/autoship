...
const SCHEMA = {
  ...
  dailyDigestEnabled: {
    envKey: "DAILY_DIGEST_ENABLED",
    default: true,
    type: "boolean",
    label: "Daily Digest",
    description: "Send a daily summary digest to Slack covering yesterday's tasks",
    group: "slack",
  },
  dailyDigestHour: {
    envKey: "DAILY_DIGEST_HOUR",
    default: 9,
    type: "number",
    label: "Daily Digest Hour",
    description: "Hour of day (0-23) for the daily digest",
    group: "slack",
    min: 0,
    max: 23,
  },
